            ...
            <div id={rootId} class="w-full lg:max-w-[200px] max-w-[160px]">
              <div class="h-[50px] w-full">
                {extraProducts.value.length > 1 && (
                  <>
                    <Slider.NextButton class="w-full p-3 px-0 md:px-3 flex items-center justify-center gap-2.5 text-neutral-400 hover:bg-primary hover:text-primary-content text-sm font-medium border border-neutral-400 transition">
